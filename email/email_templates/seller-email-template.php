...
$_SESSION['seller_email'] = '<!DOCTYPE html>
...
$_SESSION['seller_email'] .= '<div style="background-color:transparent;">
...
<p style="font-size: 24px; line-height: 1.2; text-align: left; word-break: break-word; mso-line-height-alt: 29px; margin: 0;"><span style="font-size: 24px;"><strong>CUSTOMER ADDRESS INFO</strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
'.$_SESSION['city'].', '.$_SESSION['country'].'<br/>'.$_SESSION['company'].'<br/>'.$_SESSION['tel'].'</p>
</div>
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<div style="line-height: 1.2; font-size: 12px; color: #052d3d; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14px;">
<p style="line-height: 1.2; font-size: 34px; text-align: center; word-break: break-word; mso-line-height-alt: 41px; margin: 0;"><span style="font-size: 34px;"><strong><span style="font-size: 34px;"><span style="color: #fc7318; font-size: 34px;">Got a question?</span><br/></span></strong><span style="font-size: 34px;">Call Blaise!</span></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
